...
Date: 8/11/2019
Homework: Decision Trees Questions #1-4

Implement a Decision Tree classifier. For each week, your feature set is
...
year 2. Use "entropy" as the splitting criteria (this is the default).
...
if __name__ == '__main__':
    ...
    pred_2018 = tree_predict(df_2017, df_2018)
